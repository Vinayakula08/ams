        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin:0% 25% 0% 25%">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="https://enam.gov.in/web/Slider_gallary/1/img_6.jpg" alt="First slide">
                
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="https://enam.gov.in/web/Slider_gallary/1/img_7.jpg" alt="Second slide">
                
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="https://enam.gov.in/web/Slider_gallary/1/img_8.jpg" alt="Third slide">
          ...
          <div class="latest-news pull-right">
            <div class="sidebar-header-title" style="font-size:14px; background-color: #17A2b8;"><span class="e-text-news">What's New</span></div>
            <div  class="focus-news">		
                <marquee onMouseOut="start();" onMouseOver="stop();" direction="up" scrollamount="2" style="background-color: #49c3d6;">
