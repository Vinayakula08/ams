...
<body>
    ...
    ?>
        ...
        <br>	<div class="container"><div class="quick-links-btn-sec pull-left"> 
                <div class="quick-link-list " style="border-radius: 10%;">
                    <img src="images/vinay.jpg" height="215" width="250" alt="Vinay">
                </div></div>
                <div class="container"><div class="quick-links-btn-sec pull-right"> 
                    <div class="quick-link-list" style="border-radius: 10%;">
                        <img src="images/phani.jpg" height="215" width="250" alt="Phnanidra">
                    </div></div>

        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="margin:0% 25% 0% 25%" style="text-align: justify;">
           <b> Agriculture Marketing System is a user-friendly platform where farmers can sell their goods at their 
            desired price without external intervention of mediators in the markets. We provide platform to traders where they
            can bid price for the commodities through the platform. We are committed to remove the mediator dominance in Agriculture goods 
            marketing through our system. The platform is the mediator for trading between farmers and 
            traders. We are a team of two members, Mr. Akula Vinay Kumar, B.tech Final year undergraduate in Computer Science 
            Engineering and Mr. Pothula Phanindra,B.tech Final year undergraduate in Computer Science Engineering
            committed to develop this system after facing and seeing real time struggles of the farmers across the state.</b> 
          </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                          <input type="radio" id="trader" name="role" value="TRADER">
    ...
    <div class="container" style="color:white">
        <div class="row">
            <div class="col-4">
                <p style="color: black;"><strong>VISION</strong><br />
                    To promote uniformity in agriculture marketing by
                    streamlining of procedures across the integrated markets, removing information asymmetry between buyers and sellers and promoting real time price discovery based
                    on actual demand and supply.</p>
            </div>
        
            <div class="col-4">
                <p style="color: black;"><strong>MISSION</strong><br />
                    Integration of online Agiculture Markets across the country through a common online market platform to facilitate pan-India trade in agriculture commodities, providing better price discovery through transparent auction process based on quality of produce along with timely online payment.</p>
            </div>
